                                     ...
                                     const std::string& objPath)
{
    ...
    if (threshold.contains("CriticalHigh") || threshold.contains("CriticalLow"))
    {
        ...
        criticalIface->criticalHighHysteresis(threshold.value(
            "CriticalHighHysteresis", defaultHysteresis));
        criticalIface->criticalLowHysteresis(threshold.value(
            "CriticalLowHysteresis", defaultHysteresis));
    }
    ...
    if (threshold.contains("WarningHigh") || threshold.contains("WarningLow"))
    {
        ...
        warningIface->warningHighHysteresis(threshold.value(
            "WarningHighHysteresis", defaultHysteresis));
        warningIface->warningLowHysteresis(threshold.value(
            "WarningLowHysteresis", defaultHysteresis));
    }
        ...
        threshold.contains("HardShutdownLow"))
    {
        ...
        hardShutdownIface->hardShutdownHighHysteresis(threshold.value(
            "HardShutdownHighHysteresis", defaultHysteresis));
        hardShutdownIface->hardShutdownLowHysteresis(threshold.value(
            "HardShutdownLowHysteresis", defaultHysteresis));
    }
        ...
        threshold.contains("SoftShutdownLow"))
    {
        ...
        softShutdownIface->softShutdownHighHysteresis(threshold.value(
            "SoftShutdownHighHysteresis", defaultHysteresis));
        softShutdownIface->softShutdownLowHysteresis(threshold.value(
            "SoftShutdownLowHysteresis", defaultHysteresis));
    }
        ...
        threshold.contains("PerformanceLossLow"))
    {
        ...
        perfLossIface->performanceLossLowHysteresis(threshold.value(
            "PerformanceLossLowHysteresis", defaultHysteresis));
    }
}

std::string VirtualSensor::getThresholdType(const std::string& name, int severity)
{
