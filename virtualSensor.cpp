...
{
    auto criticalHigh = criticalIface->criticalHigh();
    auto criticalLow = criticalIface->criticalLow();
    auto warningHigh = warningIface->warningHigh();
    auto warningLow = warningIface->warningLow();
