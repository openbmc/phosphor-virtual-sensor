...
struct Threshold<WarningObject> : public WarningObject, public Hysteresis
{
    ...
    using ReadingAboveUpperWarningThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingAboveUpperWarningThreshold;
    using ReadingBelowLowerWarningThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingBelowLowerWarningThreshold;
    ...
    {
        assertedHighLog = lg2::commit(ReadingAboveUpperWarningThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", high()));
    ...
    {
        assertedLowLog = lg2::commit(ReadingBelowLowerWarningThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", low()));
...
struct Threshold<CriticalObject> : public CriticalObject, public Hysteresis
{
    ...
    using ReadingAboveUpperCriticalThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingAboveUpperCriticalThreshold;
    using ReadingBelowLowerCriticalThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingBelowLowerCriticalThreshold;
    using Unit = sdbusplus::xyz::openbmc_project::Sensor::server::Value::Unit;
    ...
    auto alarmHighSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedHighLog = lg2::commit(ReadingAboveUpperCriticalThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", high()));
    ...
    auto alarmLowSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedLowLog = lg2::commit(ReadingBelowLowerCriticalThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", low()));
    ...
    public Hysteresis
{
    ...
    using ReadingAboveUpperSoftShutdownThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingAboveUpperSoftShutdownThreshold;
    using ReadingBelowLowerSoftShutdownThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingBelowLowerSoftShutdownThreshold;
    using Unit = sdbusplus::xyz::openbmc_project::Sensor::server::Value::Unit;
    std::optional<sdbusplus::message::object_path> assertedHighLog;
    std::optional<sdbusplus::message::object_path> assertedLowLog;
    ...
    auto alarmHighSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedHighLog = lg2::commit(ReadingAboveUpperSoftShutdownThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", high()));
    ...
    auto alarmLowSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedLowLog = lg2::commit(ReadingBelowLowerSoftShutdownThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", low()));
    ...
    public Hysteresis
{
    ...
    using ReadingAboveUpperHardShutdownThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingAboveUpperHardShutdownThreshold;
    using ReadingBelowLowerHardShutdownThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingBelowLowerHardShutdownThreshold;
    using Unit = sdbusplus::xyz::openbmc_project::Sensor::server::Value::Unit;
    std::optional<sdbusplus::message::object_path> assertedHighLog;
    std::optional<sdbusplus::message::object_path> assertedLowLog;
    ...
    auto alarmHighSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedHighLog = lg2::commit(ReadingAboveUpperHardShutdownThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", high()));
    ...
    auto alarmLowSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedLowLog = lg2::commit(ReadingBelowLowerHardShutdownThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", low()));
    ...
    public Hysteresis
{
    ...
    using ReadingAboveUpperPerformanceLossThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingAboveUpperPerformanceLossThreshold;
    using ReadingBelowLowerPerformanceLossThreshold = sdbusplus::error::xyz::openbmc_project::sensor::Threshold::ReadingBelowLowerPerformanceLossThreshold;
    using Unit = sdbusplus::xyz::openbmc_project::Sensor::server::Value::Unit;
    ...
    auto alarmHighSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedHighLog = lg2::commit(ReadingAboveUpperPerformanceLossThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", high()));
    ...
    auto alarmLowSignalAsserted(V value, const std::string& objPath, Unit unit)
    {
        assertedLowLog = lg2::commit(ReadingBelowLowerPerformanceLossThreshold("SENSOR_NAME", objPath, "READING_VALUE", value, "UNITS", unit, "THRESHOLD_VALUE", low()));
